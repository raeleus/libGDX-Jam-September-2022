...
public class EarthquakeEffect extends ShaderVfxEffect implements ChainVfxEffect {
    ...
    public EarthquakeEffect(float amount, float speed) {
        super(VfxGLUtils.compileShader(Gdx.files.classpath("gdxvfx/shaders/screenspace.vert"), Gdx.files.internal("shaders/earthquake.frag")));
        this.amount = amount;
        this.speed = speed;
        rebind();
    }
